...
module.exports = {
    ...
    triggers: ['beforeRequest', 'request', 'responseData', 'io'],
        ...
        httprequest: function (payload, next) {
            ...
            async.applyEachSeries(prehelpers, context, self, function (err) {
                ...
                self.requester.create({
                    ...
                    xhr = requester.request(sendId, item.request, context.protocolProfileBehavior, self.triggers.responseData, function (err, res, req, cookies, history) {
                        err = err || null;
                        ...
                        var nextPayload = {
                            ...
                            complete = function (error, options) {
                                ...
                                //          Don't break it.
                                afterRequest(error, res, req, cookies, history);
