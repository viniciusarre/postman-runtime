...
_.assign(Requester.prototype, /** @lends Requester.prototype */ {
     ...
     */
    request: function (id, request, protocolProfileBehavior, onDataCallback, callback) {
        var self = this,
            cookieJar,
            requestOptions,
        ...
        return requests(request, requestOptions, onDataCallback, function (err, res, resBody, debug) {
            if (err) {
